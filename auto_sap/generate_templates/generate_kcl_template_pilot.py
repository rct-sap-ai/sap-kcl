...
kcl_template_v02 = Template(
    template_path = files("auto_sap").joinpath("templates/sapai_kcl_template_v0.2_clean_pilot.docx"), 
    ...
    template_name = "sapai_kcl_template_v0.2_clean_pilot.docx", # this is identifying information that is recorded in the SAP
